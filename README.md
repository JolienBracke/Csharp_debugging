[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/lT1ImHro)
# itc1-csharp-bugfixing
Deze applicatie bevat de startcode voor een opdracht onder het OPO IT Challenges 1.

## Studenten
- Jolien Bracke (r0982394)
- Eline De Backer (r1067982)
...
1.  Program.cs:2       		-	De methode ToonTitle() aangepast naar ToonTitel()
2.  Program.cs:118     		-	De methode Fileoperations.FilterProcessoren() aangepast naar Fileoperations.FilterMoederborden()
3.  Toetsenbord.cs:27  		-	In de base van de constructor prijs en heeftRgbverlichting omgewisseld
4.  Program.cs:4       		-	Null aangepast naar new Aankoop()
5.  Program.cs:116     		-	"processor" aangepast naar "moederbord"
6.  Processor.cs:55-59 		- 	attributen naar properties veranderd
7.  Geheugen.cs:23       	-	ModuleGrootte naar value veranderd
8.  GrafischeKaart.cs:23 	-	set value en _werkgeheugen omgedraaid
9.  Onderdeel.cs:15 		- 	Prijs aangepast naar _prijs
10. FileOperations.cs:154 	-	string watDoetDitHier weggehaald
11. FileOperations.cs:138	-	dubbele lijn accessoireGegevens weggehaald
12. Muis.cs:27			-	In de base van de constructor Merk en model verwisseld
13. Muis.cs:35			-	Prijsgegevens tussen base en aantal
14. Accessoire.cs:40		- 	in de set > aangepast naar <
15. Program.cs:33		- 	While lus aangepast naar if-statement
16. Program.cs:44 		-       While lus aangepast naar if statement
17. Toetsenbord.cs:36		- 	Prijs toegevoegd tussen base en layout 
18. Program.cs:51		-	Dubbele lijn code verwijderd (optieToetsebord = KeuzeOptie("toetsenbord"))
19. Software.cs:29		-	In de constructor de property met variabelen omgedraaid
20. Aankoop.cs:37		-	Toegevoegd: Software = new List<Software>();
21. Aankoop.cs:59-60		-	Bij Accessoires en Software = aangepast naar +=
22. Software.cs:58		-	While lus aangepast naar if statement
23. Software.cs:70		-	Dubbele lijn code verwijderd (optieSoftware = KeuzeOptie("software"))
